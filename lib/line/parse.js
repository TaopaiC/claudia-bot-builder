...
module.exports = function(messageObject) {
  if (messageObject && messageObject.replyToken && messageObject.source && messageObject.message && messageObject.message.text ) {
    return {
  ...
  } else if (messageObject && messageObject.replyToken && messageObject.source && messageObject.postback && messageObject.postback.data) {
    return {
      replyToken: messageObject.replyToken,
      sender: messageObject.source.userId || messageObject.source.groupId || messageObject.source.roomId,
  ...
  } else if (messageObject && messageObject.source) {
    const parsed = {
      sender: messageObject.source.userId || messageObject.source.groupId || messageObject.source.roomId,
